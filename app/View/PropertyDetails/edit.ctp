...
<?php echo $this->Form->create('PropertyDetail'); ?>
	<fieldset>
		<legend><?php echo __('Edit Property Detail'); ?></legend>
	<?php
		echo $this->Form->input('id');
		echo $this->Form->input('property_id');
		echo $this->Form->input('business');
		echo $this->Form->input('source_type', array('options' => ['Sign','Flier','Cold Call Telephone','Cold Call Canvassing','Co-Broker','Other']));
